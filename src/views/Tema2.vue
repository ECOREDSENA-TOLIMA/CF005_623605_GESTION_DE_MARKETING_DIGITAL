...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .cajon.color-secundario.p-4.mb-4(data-aos="zoom-in-up")
      .row.justify-content-center.align-items-center
        .col-lg-10(data-aos="flip-right")
          p La divulgación de contenido tiene como objetivo ampliar los leads y los consumidores digitales, a través de la divulgación de información que sea atrayente y de interés; con la finalidad de generar valor para la marca. 
          p Se aplican dos estrategias de #[i marketing] digital en la divulgación para el posicionamiento de marca, entre las cuales están el posicionamiento SEO (#[i Search Engine Optimization]) y SEM (#[i Search Engine Marketing]).
        .col-lg-2
          figure  
        ...
        .tabla-b.color-acento-botones.mb-5        
          table(border=1)
            thead(style="background-color:#33ECE0;")
              tr
                th.text-center La relevancia              
                th.text-center La autoridad
            tbody
    ...
    .row.justify-content-center.align-items-center.mb-5
      .cajon.color-secundario.p-4.mb-4(data-aos="flip-right")
        ...
        .row.justify-content-center.align-items-center.mb-5
          .col-lg-4
            figure  
              img(src='@/assets/curso/temas/tema2/img3.jpg', alt='Imagen decorativa')
          .col-lg-8
            ul.lista-ul              
              li 
                i.fas.fa-circle.fa-xs(style="color:#627289")
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12(data-aos="flip-right")
        p La dinamización de las plataformas digitales para el #[i marketing] digital requiere el diseño y uso de contenido de valor que conecte realmente a los usuarios de mercados objetivos para la organización, en el siguiente video se encuentran detallados recursos que aportan al cumplimiento de las estrategias publicitarias proyectadas. 
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-12.movil(data-aos="flip-left")
        figure  
          img(src='@/assets/curso/temas/tema2/img11_1.svg', alt='Imagen decorativa')
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.colortarj-1.p-5
        ...
        h2.text-center Facebook
        p Es la red social más utilizada y cuenta con mayor interacción en los horarios de 1:00 p. m. a 3:00 p. m., se recomienda que se realice una publicación al día en horario laboral, es decir de lunes a viernes.
      .col-md.tarjeta.colortarj-2.p-5
        .row.justify-content-center.mb-4
          .col-6
            figure
              img(src='@/assets/curso/temas/tema2/img15.png', alt='')
        h2.text-center Instagram
        p Es la red más importante de acuerdo con los mercados digitales y de las redes sociales; sin embargo, es la segunda red más utilizada a nivel mundial; se identifica que los usuarios emplean la red preferiblemente en la mañana, pero se recomienda publicar contenido en horarios de 5:00 p. m. a 6:00 p. m.
      .col-md.tarjeta.colortarj-1.p-5
        .row.justify-content-center.mb-4
          .col-6
            figure
      ...
      .col-md.tarjeta.colortarj-2.p-5
        ...
        h2.text-center LinkedIn
        p Se recomienda realizar publicación de contenido en horario de 9:00 a. m. a 5:00 p. m. y presenta interacciones en horarios de 10:00 a. m. a 11:00 a. m. 
    Separador
    .row
      .col-xl-12
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-6 
        figure
          img(src='@/assets/curso/temas/tema2/img27.jpg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-3
        .tarjeta-avatar
          ...
          .tarjeta.colorcol1.w-100
            .p-4
              h3.text-center Instagram
              p Es una red social en la que se encuentra contenido digital con altos estándares de calidad, cuida mucho la apariencia y la imagen; el #[b video #[i marketing]] se presenta en las historias o los #[i reels], IGTV. Se debe tener en cuenta que esta red social tiene una interfaz creada para dispositivos móviles, por lo cual los videos se presentan de forma vertical.  
      .col-lg-3
        .tarjeta-avatar
          ...
          .tarjeta.colorcol1.w-100
            .p-4
              ...
              p Es una de las redes sociales más dinámica y sencilla a la hora de crear contenido audiovisual; es la red social más utilizada en el mundo. 
              br
              br
              br
              br
      ...
      .col-lg-3
        .tarjeta-avatar
          ...
          .tarjeta.colorcol1.w-100
            .p-4
              h3.text-center YouTube
              p Es la plataforma digital con mayor contenido de videos, por lo cual es las más empleada para promover video #[i marketing].
              br
              br
              br
              br
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12(data-aos="flip-right")
        ...
        ul.lista-ul
            li 
              i.fas.fa-circle.fa-xs(style="color:#627289")
              | Se debe identificar el buyer persona (público objetivo).
            li 
              i.fas.fa-circle.fa-xs(style="color:#627289")
    ...
    .row.justify-content-center.align-items-center.fondo-2
      .col-12(data-aos="flip-right")
        ...
        .row.justify-content-center.align-items-center.mb-5
          ...
          .col-lg-4
            SlyderF.mb-5(columnas="col-lg-12 col-xl-12")(data-aos="flip-right")
              .tarjeta.colorpaso.p-4
                .row.justify-content-center.mb-3
                  .col-5
                    img.mb-4(src='@/assets/curso/temas/tema2/img41.svg' alt='AvatarTop')
                  .col-12
                    p.text-center Es un medio digital de comunicación directo con el público objetivo, y también permite crear comunidades virtuales, a partir de un tema de interés
              .tarjeta.colorpaso.p-4
                .row.justify-content-center.mb-3
                  .col-5
                    img.mb-4(src='@/assets/curso/temas/tema2/img42.svg' alt='AvatarTop')
                  .col-12
                    p.text-center Es una plataforma de bajo costo, en muchos casos es de acceso gratis, también es una herramienta sencilla para crear contenido.
              .tarjeta.colorpaso.p-4
                .row.justify-content-center.mb-3
                  .col-5
                    img.mb-4(src='@/assets/curso/temas/tema2/img43.svg' alt='AvatarTop')
                  .col-12
                    p.text-center Permite estar en constante actualización.
              .tarjeta.colorpaso.p-4
                .row.justify-content-center.mb-3
                  .col-5
                    img.mb-4(src='@/assets/curso/temas/tema2/img44.svg' alt='AvatarTop')
                  .col-12
                    p.text-center Permite una mayor cercanía con la población objetivo.
              .tarjeta.colorpaso.p-4
                .row.justify-content-center.mb-3
                  .col-5
                    img.mb-4(src='@/assets/curso/temas/tema2/img45.svg' alt='AvatarTop')
                  .col-12
                    p.text-center Permite recibir retroalimentación respecto al contenido y la marca.
              .tarjeta.colorpaso.p-4
                .row.justify-content-center.mb-3
                  .col-5
              ...
              .tarjeta.colorpaso.p-4
                .row.justify-content-center.mb-3
                  .col-5
                    img.mb-4(src='@/assets/curso/temas/tema2/img48.svg' alt='AvatarTop')
                  .col-12
                    p.text-center Mejora el servicio al cliente.
    Separador
    .row
      .col-xl-12
    #t_2_9.titulo-segundo.color-acento-contenido(data-aos="zoom-in-left")
    ...
    .row
      .col-xl-12
    #t_2_10.titulo-segundo.color-acento-contenido(data-aos="zoom-in-left")
      h2.my-5 2.10 Licencias
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12(data-aos="flip-right")
        p Todos los contenidos digitales publicados deben tener permisos y licencias, ya que se puede incurrir en fraudes; por lo cual existen diferentes licencias para los contenidos digitales como:
    ...
    .row.justify-content-center.mb-5
      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left")
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/temas/tema2/img50.png", alt="alt")
      ...
      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left")
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/temas/tema2/img51.png", alt="alt")
          .crd_hover_txt--body.crd_hover_txt--body2
            .icono  
              img(src="@/assets/curso/temas/tema1/flecha.svg", alt="Imagen decorativa")
            h4.mb-3 #[i Copyleft]
            p.mb-0 Esta licencia protege los derechos de autor, sin embargo, permite que las obras se usen libremente, se pueden modificar; pero siempre se debe dar reconocimiento al autor.
      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left")
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/temas/tema2/img52.png", alt="alt")
          .crd_hover_txt--body.crd_hover_txt--body2
            .icono  
              img(src="@/assets/curso/temas/tema1/flecha.svg", alt="Imagen decorativa")
            h4.mb-3 #[i Creative Commons]
            p.mb-0 Esta licencia permite usar y compartir contenido digital de manera gratuita; reconociendo los derechos de autor; esta comunidad distingue seis licencias, By, no comercial, no comercial-compartir igual, sin obras derivadas.
      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt(data-aos="flip-left")
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/temas/tema2/img53.png", alt="alt")
          .crd_hover_txt--body.crd_hover_txt--body2
            .icono  
              img(src="@/assets/curso/temas/tema1/flecha.svg", alt="Imagen decorativa")
            h4.mb-3 GNU GPL
    ...
    datosLineaTiempoB: [
      {
        titulo: 'Idea',
        texto:
          'Realizar una lluvia de ideas de que desea transmitir, como desea presentar el contenido.',
        icono: require('@/assets/curso/temas/tema2/img32.svg'),
      },
      {
        titulo: 'Mensaje',
        texto:
      ...
      },
      {
        titulo: 'Guion',
        texto:
          'En este se construye todos los elementos que contendrá el video, herramientas audiovisuales, secuencia, mensajes, y duración.',
        icono: require('@/assets/curso/temas/tema2/img34.svg'),
      },
      {
        titulo: 'Equipos y elementos',
        texto:
          'Tener todos los dispositivos necesarios para la grabación del video, filmadora, micrófono, luces, entre otros.',
        icono: require('@/assets/curso/temas/tema2/img35.svg'),
      },
      {
        titulo: 'Registro o grabación',
        texto: 'Búsqueda de locación, grabar siguiendo el guion.',
        icono: require('@/assets/curso/temas/tema2/img36.svg'),
      },
      {
